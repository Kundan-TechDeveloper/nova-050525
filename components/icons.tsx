...
export const CopyIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} strokeLinejoin="round" viewBox="0 0 16 16" width={size} style={{ color: "currentcolor" }}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.5 1H4.5C3.67157 1 3 1.67157 3 2.5V10.5C3 11.3284 3.67157 12 4.5 12H11.5C12.3284 12 13 11.3284 13 10.5V2.5C13 1.67157 12.3284 1 11.5 1ZM4.5 2.5H11.5V10.5H4.5V2.5ZM1.5 5.5C1.5 4.67157 2.17157 4 3 4H3.75V5.5H3V13.5H10V13H11.5V13.5C11.5 14.3284 10.8284 15 10 15H3C2.17157 15 1.5 14.3284 1.5 13.5V5.5Z"
      fill="currentColor"
    />
  </svg>
)
...
export const ThumbUpIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} strokeLinejoin="round" viewBox="0 0 16 16" width={size} style={{ color: "currentcolor" }}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M4.5 7.49999V14H2.5C1.94772 14 1.5 13.5523 1.5 13V8.49999C1.5 7.94771 1.94772 7.49999 2.5 7.49999H4.5ZM6 7.49999V14H11.5C12.8807 14 14 12.8807 14 11.5V10.2C14 9.95261 13.9298 9.71478 13.8 9.51999L10.8 4.99999C10.6 4.69999 10.2 4.49999 9.8 4.49999C9.2 4.49999 8.7 4.99999 8.7 5.59999L8.5 7.49999H6Z"
      fill="currentColor"
    />
  </svg>
)
...
export const ThumbDownIcon = ({ size = 16 }: { size?: number }) => (
  <svg height={size} strokeLinejoin="round" viewBox="0 0 16 16" width={size} style={{ color: "currentcolor" }}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M4.5 8.50001V2H2.5C1.94772 2 1.5 2.44772 1.5 3V7.50001C1.5 8.05229 1.94772 8.50001 2.5 8.50001H4.5ZM6 8.50001V2H11.5C12.8807 2 14 3.11929 14 4.5V5.8C14 6.04739 13.9298 6.28522 13.8 6.48001L10.8 11C10.6 11.3 10.2 11.5 9.8 11.5C9.2 11.5 8.7 11 8.7 10.4L8.5 8.50001H6Z"
      fill="currentColor"
    />
  </svg>
)
...
export const DocumentIcon = ({
  ...
  fileType = "",
  className = "",
}: { size?: number; fileType?: string; className?: string }) => {
  ...
  const getIcon = () => {
    ...
    if (ext === "pdf") {
      return (
        <img
          src="/images/pdf-document-svg.svg"
          alt="PDF file"
          width={size}
          height={size}
          className={className}
    ...
    if (ext === "text") {
      return (
        <img
          src="/images/txt-document-svg.svg"
          alt="Text file"
          width={size}
          height={size}
          className={className}
